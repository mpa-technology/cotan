...
template<typename RandEngine , typename CST = char>
...
public:
    ...
    StringGenerator(const seedType &seed,const RandEngine &randEngine):seed_(seed),rengine_(randEngine){}
    ...
    const RandEngine& getRandEngine()const{
        return rengine_;
    }
