...
cotan::Mt19937RandEngine::Mt19937RandEngine(){
    _init();
}
...
void cotan::Mt19937RandEngine::_init_genrand64(cotan::Mt19937RandEngine::generateType seed)
{
    mt[0] = seed;
...
void cotan::Mt19937RandEngine::_init_by_array64(Mt19937RandEngine::generateType init_key[], Mt19937RandEngine::generateType key_length)
{
    generateType i, j, k;
